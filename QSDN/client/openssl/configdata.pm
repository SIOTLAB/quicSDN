...
our %config = (
  ...
  openssldir => "",
  options => "enable-tls1_3 --prefix=/home/puneetkumar/multiplexing/openflow_quic/openssl/build no-asan no-crypto-mdebug no-crypto-mdebug-backtrace no-devcryptoeng no-ec_nistp_64_gcc_128 no-egd no-external-tests no-fuzz-afl no-fuzz-libfuzzer no-heartbeats no-md2 no-msan no-rc5 no-sctp no-ssl-trace no-ssl3 no-ssl3-method no-tls13downgrade no-ubsan no-unit-test no-weak-ssl-ciphers no-zlib no-zlib-dynamic",
  perl_archname => "x86_64-linux-gnu-thread-multi",
  perl_cmd => "/usr/bin/perl",
  perl_version => "5.26.1",
  perlargv => [ "linux-x86_64", "enable-tls1_3", "--prefix=/home/puneetkumar/multiplexing/openflow_quic/openssl/build" ],
  perlenv => {
      "AR" => undef,
      "ARFLAGS" => undef,
      "AS" => undef,
  ...
  prefix => "/home/puneetkumar/multiplexing/openflow_quic/openssl/build",
  processor => "",
