...
class OpenFlowController(object):
    ...
    def server_loop(self):
        UDPServerSocket =  open_udp_socket(self.ofp_udp_listen_port)
        #UDPServerSocket =  ryu.base.app_manager.open_udp_socket(self.ofp_udp_listen_port)
        #UDPServerSocket = socket.socket(family=socket.AF_INET, type=socket.SOCK_DGRAM)
        #print("Socket type is ", type(UDPServerSocket))
